...
final class Version20240107042711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX idx_survey_mapping__uuid__user_id ON survey_mapping(uuid, user_id);');
        $this->addSql('CREATE INDEX idx_survey_mapping__uuid_new ON survey_mapping(uuid_new);');
        $this->addSql("COMMENT ON TABLE survey_mapping IS 'Список новых uuid для повторного прохождения и сохранения результатов (абстракция вместо Redis)';");
        $this->addSql("COMMENT ON COLUMN survey_mapping.id IS 'Идентификатор';");
        $this->addSql("COMMENT ON TABLE survey_mapping.uuid IS 'Внешний ключ survey_assignment.survey_uuid';");
        $this->addSql("COMMENT ON TABLE survey_mapping.user_id IS 'Внешний ключ users.id';");
        $this->addSql("COMMENT ON TABLE survey_mapping.uuid_new IS 'Новый UUID';");
        ...
        $this->addSql("COMMENT ON TABLE survey_results.uuid IS 'Внешний ключ survey_mapping.uuid_new';");
        ...
        $this->addSql("COMMENT ON TABLE survey_statistics.uuid IS 'Внешний ключ survey_mapping.uuid_new';");
